...
record `sex` (female, male) and `year` (2007–2009). The mean flipper
length is 200.9 mm; this calculation excludes 2 missing values.
...
return `NA`: `mean()` does not directly average character or factor
vectors.
